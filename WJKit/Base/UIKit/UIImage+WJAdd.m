...
WJSYNTH_DUMMY_CLASS(UIImage_Add)
...
static NSTimeInterval _wj_CGImageSourceGetGIFFrameDelayAtIndex(CGImageSourceRef source, size_t index) {
...
+ (UIImage *)imageWithSmallGIFData:(NSData *)data scale:(CGFloat)scale {
    ...
    NSUInteger gcdFrame = 0; //Greatest Common Divisor Frame
    for (size_t i = 0; i < count; i++) {
        NSTimeInterval delay = _wj_CGImageSourceGetGIFFrameDelayAtIndex(source, i);
        totalTime += delay;
