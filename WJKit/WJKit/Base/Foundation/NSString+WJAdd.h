...
/**
 Returns the height of a string with specified fontSize
 
 @param fontSize   The fontSize to use for computing the string size.
 
 @return       The height of the resulting string's bounding box.
 */
+ (CGFloat)heightForFontSize:(CGFloat)fontSize;
